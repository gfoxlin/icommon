...
+ (SecKeyRef)addPublicKey:(NSString *)key {
    ...
    /** 如果是base64编码的，解码 */
    NSData *data = [Base64 decode:key];//base64_decode(key);
...
+ (NSString *)encryptString:(NSString *)str publicKey:(NSString *)pubKey {
    ...
    NSString *ret = [Base64 encode:data];//base64_encode_data(data);
    return ret;
}
...
+ (NSString *)decryptString:(NSString *)str privateKey:(NSString *)privKey {
    /** 如果是base64编码的，需要解码 */
    NSData *data = [Base64 decode:str];//base64_decode(str);
